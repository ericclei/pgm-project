 ...
 *
 */
public class SyntheticDataset1Relation implements
		CollectiveMatrixFactorizationDataset {

	private Matrix f1, f2, r12;
	private final int N_ENTITIES = 2;
	private final int[] N = { 1000, 1000 };
	private final int[] D = { 100, 100 };
	private final int N_OBS_R12 = 50000;

	public SyntheticDataset1Relation(String f1Path, String f2Path,
			String r12Path, boolean isSparse) {
		if (isSparse) {
