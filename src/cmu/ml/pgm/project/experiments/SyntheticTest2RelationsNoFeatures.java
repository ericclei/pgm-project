...
public class SyntheticTest2RelationsNoFeatures {

	public static void main(String[] args) {
		CollectiveMatrixFactorizationDataset mfTrain = new SyntheticDataset2RelationsNoFeatures(
		...
		int maxIterOuter = 20;
		int maxIterInner = 10;
		CollectiveMatrixFactorizationDataset mfTest = new SyntheticDataset2RelationsNoFeatures(
