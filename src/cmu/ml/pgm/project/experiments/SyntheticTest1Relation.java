...
public class SyntheticTest1Relation {

	public static void main(String[] args) {
		CollectiveMatrixFactorizationDataset mfTrain = new SyntheticDataset1Relation(
		...
		int maxIterOuter = 20;
		int maxIterInner = 10;
		CollectiveMatrixFactorizationDataset mfTest = new SyntheticDataset1Relation(
				"Data/synthetic/F.1.dat", "Data/synthetic/F.2.dat",
